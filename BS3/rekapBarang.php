		...
		<nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Rekap Barang</a>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Rekap Barang</h4>
                                <p class="category">Here is a subtitle for this table</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <?php 
                                    ...
                                    $query = "SELECT kategori.id_kategori as idk ,kategori.nama as Kategori, sub_kategori.nama as Sub_Kategori, barang.nama as Produk,(select count(kategori) from barang where kategori = kategori.id_kategori) as jumlah  FROM kategori,sub_kategori,barang WHERE barang.kategori=kategori.id_kategori and barang.sub_kategori = sub_kategori.idsub_kategori";
                                    $result = mysqli_query($con,$query);
