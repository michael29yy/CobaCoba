		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="BS3/PBP/<?php echo $row['gambar']?>" alt=""></div>
				</div>
				<!-- Description -->
				<div class="col-lg-5 order-3">
					<div class="product_description">
						<?php 
						$idka = $row['kategori'];
						$query2 = "SELECT * FROM kategori where id_kategori = $idka";
						$result2 = mysqli_query($con,$query2); 
						$row2 = mysqli_fetch_assoc($result2);
						?>
						<div class="product_category"><?php echo $row2['nama']?></div>
						<div class="product_name"><?php echo $row['nama']?></div>
